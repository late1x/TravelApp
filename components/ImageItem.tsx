...
// Component to display an image item with a remove button
const ImageItem = ({ item, userId, onRemoveImage, onImagePress }: { item: FileObject; userId: string; onRemoveImage: () => void; onImagePress: (imageUri: string) => void }) => {
