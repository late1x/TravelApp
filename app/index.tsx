...
const Login = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>TravelApp</Text>
      <Text style={styles.subheader}>Aplicacion de viajes</Text>
      <TextInput
        autoCapitalize="none"
      ...
      <Text style={{ textAlign: 'center', color: '#fff' }}>No tienes una cuenta?</Text>
